...
WORKDIR /opt/
RUN wget https://github.com/igniterealtime/Openfire/releases/download/v4.5.4/openfire_4_5_4.tar.gz && tar -zxvf openfire_4_5_4.tar.gz && rm openfire_4_5_4.tar.gz
